...
def display_instructions():
    ...
    print("              Instructions:                             ")
    print("              1. You will be asked to input the following variables please input integer variables as a number without measurement details.")
    ...
    print("              7. Weight (Kg).")
    print("              8. Height (cm).")
    print("              9. Number of family members with diabetes (calculate diabetes pedigree function, these must be BLOOD related family members.")
    print("              10. Age (years).")
